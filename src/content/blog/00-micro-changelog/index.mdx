...
[Giscus](https://giscus.app) leverages Github discussions to act as a comments system. To get Giscus working on your own website, see [here](/ghwebsite/blog/01-getting-started#deploy-the-site).
...
- [Fixed](https://github.com/trevortylerlee/astro-micro/issues/4): ToC links are obscured by Header when scrolled to
